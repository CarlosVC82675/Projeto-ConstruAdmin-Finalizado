...
<div>
<div class="note note-danger mb-3" style="margin-top: 30vh; width:70vw;margin-left:5vw;" >
    <strong>Nota de aviso:</strong> parte destinada a lista de Responsaveis vinculados a atividade, que não fazem parte da administração da obra de acordo com as atribuições no sistema.<br>
...
<div class="container pt-4 border rounded table-responsive" style="margin-top: 10vh; width:70vw;" >
    <div class="card-header my-4 text-center ">
        <h5 class="card-title mt-2">LISTA DE RESPONSAVEIS</h5>
    </div>
...
@if(strcasecmp($role->name, 'Engenheiro')  && strcasecmp($role->name, 'Administrador') && strcasecmp($role->name, 'Comum') && strcasecmp($role->name, 'Apontador'))
          <tr>
            <td>
...
<div class="card text-center border border-warning "  style="margin-top: 20vh; width:50vw;" >
    ...
    <div class="card-body">
      <h5 class="card-title">Não encontramos Responsaveis vinculados a atividades</h5>
      <p class="card-text">Provavelmente voce não tem atividade registrada ou não tem Responsaveis rasos 
