...
@section('conteudo')
   ...
   <form action="{{ route('atualizar.usuario', ['id' => $usuario->idUsuario])}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" aria-label="Default select example" name="atribuicao_Usuario_id_Atribuicao" disabled>
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="password" class="form-control" name="cpf" placeholder="{{$usuario->cpf}}" value="{{$usuario->cpf}}" disabled>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="tel" pattern="[0-9]{10}" class="form-control" name="telefone1" placeholder="" value="" required>
          </div>
          <div class="mb-3">
            <label class="form-label">Telefone 2(Opcional)</label>
            <input type="tel" pattern="[0-9]{10}" class="form-control"  name="telefone2" placeholder="">
          </div>
          <div class="mb-3">
            <label class="form-label">Telefone 3(Opcional)</label>
            <input type="tel" pattern="[0-9]{10}" class="form-control" name="telefone3" placeholder="">
          </div>

        <button type="submit" class="btn btn-primary">Editar</button>
      </form>

      <button class="btn btn-primary mt-5">Deletar</button>
