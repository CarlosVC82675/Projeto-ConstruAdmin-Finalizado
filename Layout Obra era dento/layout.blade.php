...
<body>
    ...
    <div class="navbar-c">
        <a href="#">
        <img src="{{url("storage/img/capacete.png")}}" alt="" class="img-icone">
         </a>
        <p class="logan">ConstruAdmin</p>
        <div class="obra">
        <p>Obra {{$obra->nome}}</p>
         </div>
        <img src="{{url("storage/img/sino.png")}}" alt="" class="img-sino">
        <p class="atribuicao">Supervisor</p>
        <img src="{{url("storage/img/avatar-de-perfil.png")}}" alt="" class="img-avatar">
